...
class CustomJustAudioMediaKit extends JustAudioPlatform {
  CustomJustAudioMediaKit();

  static final Map<String, MediaKitPlayer> activePlayers = {};

  /// The internal MPV player's logLevel
  static MPVLogLevel mpvLogLevel = MPVLogLevel.debug;
  ...
  static final _logger = Logger('CustomJustAudioMediaKit');
  ...
  static void registerWith() {
    JustAudioPlatform.instance = CustomJustAudioMediaKit();
  }
  ...
  Future<AudioPlayerPlatform> init(InitRequest request) async {
    ...
    activePlayers[request.id] = player;
    await player.ready();
  ...
  Future<DisposePlayerResponse> disposePlayer(
    ...
    activePlayers.remove(request.id);
